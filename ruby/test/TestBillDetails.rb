...
class TestBillDetails < Test::Unit::TestCase
	...
	def setup
		...
		@bill_without_grocery.add_item('Adhesive', 'utility', 1, 20)
	...
	def test_bill_completeness
		...
		assert_equal(357.5, @detailed_bill.total_cost)
		assert_equal(0, @empty.total_cost)
		assert_equal(387, @grocery_bill.total_cost)
		assert_equal(590, @bill_without_grocery.total_cost)
	end
	...
	def test_costs_eligible_for_discounts
		...
		assert_equal(590,@bill_without_grocery.non_grocery_cost)
	end
end
